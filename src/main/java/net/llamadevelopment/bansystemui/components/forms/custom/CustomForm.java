package net.llamadevelopment.bansystemui.components.forms.custom;
...
import net.llamadevelopment.bansystemui.components.forms.FormHandler;
...
public class CustomForm {
    ...
    public void send(Player player) {
        ...
        Server.getInstance().getScheduler().scheduleDelayedTask(BanSystemUI.getInstance(), () -> player.sendExperience(player.getExperience()), 20);
    }
